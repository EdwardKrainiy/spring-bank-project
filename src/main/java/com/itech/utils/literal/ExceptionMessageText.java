...
public class ExceptionMessageText {
    ...
    public static final String ACCOUNT_CREATION_REQUEST_NOT_FOUND = "Account CreationRequest with this id not found!";
    ...
    public static final String TRANSACTION_CREATION_REQUEST_NOT_FOUND = "Transaction CreationRequest with this id not found!";
