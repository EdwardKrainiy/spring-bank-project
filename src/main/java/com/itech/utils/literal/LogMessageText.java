...
public class LogMessageText {
    ...
    public static final String ACCOUNT_CREATION_REQUEST_NOT_FOUND_LOG = "Account creation request not found. Id of requested account creation request: %d";
    public static final String TRANSACTION_NOT_FOUND_LOG = "Transaction not found. Id of requested transaction: %d";
