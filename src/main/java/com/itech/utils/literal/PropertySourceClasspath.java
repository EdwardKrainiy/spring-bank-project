...
public class PropertySourceClasspath {
    ...
    public static final String SCHEDULER_PROPERTIES_CLASSPATH = "classpath:properties/scheduler.properties";
    public static final String MAIL_PROPERTIES_CLASSPATH = "classpath:properties/mail.properties";
    public static final String SECURITY_PROPERTIES_CLASSPATH = "classpath:properties/security.properties";
