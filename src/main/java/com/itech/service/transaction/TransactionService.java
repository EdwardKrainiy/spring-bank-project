...
/**
 * TransactionService interface. Provides us different methods to work with Transaction objects on
 * Service layer.
 *
...
public interface TransactionService {
  ...
  /**
   * findAccountCreationRequestById method. Finds CreationRequest with TRANSACTION CreationType by
   * id and maps to Dto;
   *
  ...
  /**
   * findTransactionCreationRequests method. Finds all CreationRequests with TRANSACTION
   * CreationType and maps to Dto;
   *
