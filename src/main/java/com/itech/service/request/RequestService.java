...
/**
 * RequestService interface. Provides us different methods to work with CreationRequestDto objects
 * on Service layer.
 *
...
public interface RequestService {
  /**
   * processCreationRequestMessage method. Processes message, sends to RabbitMQ queue and saves to
   * DB.
   *
