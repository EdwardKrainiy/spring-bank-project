...
/**
 * SchedulerConfig class. Provides us Scheduler, which checks EXPIRED Account CreationRequests and
 * marks them.
 */
@Configuration
@EnableScheduling
...
public class SchedulerConfig {
  ...
  /**
   * checkExpiredCreationRequests method. Scheduler, which marks all AccountCreationRequests, which
   * was created more than 4 hours ago as EXPIRED, and checks that every 5 minutes.
   */
