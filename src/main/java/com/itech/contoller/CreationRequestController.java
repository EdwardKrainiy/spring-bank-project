...
public class CreationRequestController {
   ...
   * @return ResponseEntity<CreationRequestDto> Response, which contains HTTP code and Dto of
   *     obtained creationRequest.
   */
  @ApiOperation(
      value = "Obtain transaction creation request by id.",
      notes = "Returns transaction creation request with id we noted.",
  ...
  public ResponseEntity<CreationRequestDto> getTransactionCreationRequestById(
      @PathVariable("id")
          @ApiParam(
              name = "id",
              value = "Id of transaction creation request we want to obtain.",
              required = true)
          Long transactionCreationRequestId) {
    return ResponseEntity.ok(
        transactionService.findTransactionCreationRequestById(transactionCreationRequestId));
  }
   ...
   */
  @ApiOperation(
      value = "Obtain account creation request by id.",
      notes = "Returns account creation request with id we noted.",
      produces = "application/json",
      response = CreationRequestDto.class)
  @ApiResponses(
      value = {
  ...
  public ResponseEntity<CreationRequestDto> getAccountCreationRequestById(
      @PathVariable("id")
          @ApiParam(
              name = "id",
              value = "Id of account creation request we want to obtain.",
              required = true)
          Long accountCreationRequestId) {
    return ResponseEntity.ok(
        accountService.findAccountCreationRequestById(accountCreationRequestId));
  }

  /**
   * getAccountCreationRequests endpoint. Returns all accountCreationRequests.
   *
   * @return ResponseEntity<List < CreationRequestDto>> Response, which contains HTTP code and all
   *     Dtos of obtained accountCreationRequests.
   */
  @ApiOperation(
      value = "Obtain all account creation requests.",
      notes = "Returns all account creation requests.",
      produces = "application/json",
      response = Iterable.class)
  @ApiResponses(
      value = {
        @ApiResponse(
            code = 200,
            message = "Successfully retrieved list of account creation requests."),
        @ApiResponse(
            code = 403,
            message = "Accessing the resource you were trying to reach is forbidden")
      })
   ...
   *
   * @return ResponseEntity<List < CreationRequestDto>> Response, which contains HTTP code and all
   *     Dtos of obtained transactionCreationRequests.
   */
  @ApiOperation(
      value = "Obtain all transaction creation requests.",
      notes = "Returns all transaction creation requests.",
      produces = "application/json",
      response = Iterable.class)
  @ApiResponses(
      value = {
        @ApiResponse(
            code = 200,
            message = "Successfully retrieved list of transaction creation requests."),
        @ApiResponse(
            code = 403,
            message = "Accessing the resource you were trying to reach is forbidden")
      })
  ...
  /**
   * approveAccountCreationRequest endpoint. Approves CreationRequest and creates account based on
   ...
   */
  @ApiOperation(
      value = "Approve account creation request.",
      notes =
          "Approves account creation request, creates account and sends message about approvement to email.")
  @ApiResponses(
      value = {
        @ApiResponse(
            code = 200,
            message = "Successfully approved account creation request and account created."),
        @ApiResponse(
            code = 403,
            message = "Accessing the resource you were trying to reach is forbidden"),
        @ApiResponse(code = 404, message = "Account creation request with this id not found.")
  ...
  public ResponseEntity<Void> approveAccountCreationRequest(
      @PathVariable("id")
          @ApiParam(
              name = "id",
              value = "Id of account creation request we want to approve.",
              required = true)
          Long accountCreationRequestId) {
  ...
  /**
   * rejectAccountCreationRequest endpoint. Rejects CreationRequest, sets CreationRequest status to
   ...
   */
  @ApiOperation(
      value = "Reject account creation request.",
      notes = "Rejects account creation request and sends message about rejection to email.")
  @ApiResponses(
      value = {
  ...
  public ResponseEntity<Void> rejectAccountCreationRequest(
      @PathVariable("id")
          @ApiParam(
              name = "id",
              value = "Id of account creation request we want to reject.",
              required = true)
          Long accountCreationRequestId) {
