...
/**
 * Transaction controller with getTransactionById, getAllTransactions and createTransaction
 * endpoints.
 *
...
public class TransactionController {
   ...
   */
  @ApiOperation(
      value = "Obtain transaction by id.",
      notes = "Returns transaction with id we noted.",
  ...
  public ResponseEntity<TransactionDto> getTransactionById(
      @PathVariable("id") @ApiParam(name = "id", value = "Id of transaction we need to obtain.")
          Long transactionId) {
    return ResponseEntity.status(HttpStatus.OK)
        .body(transactionService.findTransactionById(transactionId));
  }
   ...
   */
  @ApiOperation(
      value = "Obtain all transactions.",
      notes = "Returns all transactions, stored in DB",
      produces = "application/json",
  ...
  @ApiOperation(
      ...
      notes = "Creates new transaction and saves that one into DB.",
  ...
  @PostMapping
  public ResponseEntity<CreationRequestDto> createTransaction(
      @RequestBody
          @Valid
          @ApiParam(
              name = "transactionCreateDto",
              value = "Dto of transaction we want to create and save.")
    ...
    return ResponseEntity.status(HttpStatus.CREATED)
        .body(requestService.processCreationRequestMessage(transactionCreateDto));
  }
}
